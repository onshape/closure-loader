...
function createPrefix(loaderContext, globalVarTree, globalVars, useEval) {
    ...
    prefix += `var __prefix=require(${loaderUtils.stringifyRequest(
        loaderContext,
        require.resolve('./prefix.js'),
    )});`;
    ...
    // prefix += `__prefix.createNestedNamespaces(__closureLoaderNamespace, ${JSON.stringify(globalVars)});`;
